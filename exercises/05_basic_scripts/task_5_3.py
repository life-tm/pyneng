...
template = '\n'.join(templates_mode[input('Введите режим работы интерфейса (access/trunk):')])
...
# print(f'interface {input_interface}') - через f строки
print(template.format(input_vlans))